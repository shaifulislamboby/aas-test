...
def write_test_results_to_file(
    ...
    if not isinstance(test_result, str) and isinstance(test_result, TestResult) and not test_result.passed:
        ...
        file.write(
            ...
            not isinstance(test_result, TestResult) and isinstance(test_result, str) and 'no matching' in test_result
    ):
        length_of_dash_sign = len(
