...
try:
    from aasendpointhandlers.rstapi_endpointresources import AssetAdministrationShells,AssetAdministrationShell,ConceptDescriptions,ConceptDescription,Submodels,Submodel,AssetAdministrationShellsSubmodelRefs,SubmodelELements,SubmodelElementByIdShortPath,AASStaticSource,AASStaticWebSources,AASRTDataVisualizer,AASWebInterfaceConversationMessage
except ImportError:
    from main.aasendpointhandlers.rstapi_endpointresources import AssetAdministrationShells,AssetAdministrationShell,ConceptDescriptions,ConceptDescription,Submodels,Submodel,AssetAdministrationShellsSubmodelRefs,SubmodelELements,SubmodelElementByIdShortPath,AASStaticSource,AASStaticWebSources,AASRTDataVisualizer,AASWebInterfaceConversationMessage

try:
    from aasendpointhandlers.rstapi_endpointresources import RetrieveMessage,AASWebInterfaceHome,AASWebInterface,AASWebInterfaceStandardSubmodel,AASWebInterfaceSearch,AASWebInterfaceSubmodels,AASWebInterfaceSubmodelElemValue,AASWebInterfaceSkill,AASWebInterfaceSKillLog,AASWebInterfaceProductionManagement,AASDocumentationDownload,AASDocumentationDownload,AASDocumentationDownloadSubmodel
except ImportError:
    from main.aasendpointhandlers.rstapi_endpointresources import RetrieveMessage,AASWebInterfaceHome,AASWebInterface,AASWebInterfaceStandardSubmodel,AASWebInterfaceSearch,AASWebInterfaceSubmodels,AASWebInterfaceSubmodelElemValue,AASWebInterfaceSkill,AASWebInterfaceSKillLog,AASWebInterfaceProductionManagement,AASDocumentationDownload,AASDocumentationDownload,AASDocumentationDownloadSubmodel
...
'''
        ...
        drv_rst_api.add_resource(AASWebInterfaceSkill, "/<int:aasIndex>/<string:skillName>", resource_class_args=tuple([self.pyAAS]))
        ...
        drv_rst_api.add_resource(AASWebInterfaceSubmodelElemValue,"/<int:aasIndex>/submodels/elem",resource_class_args=tuple([self.pyAAS]))
        ...
        drv_rst_api.add_resource(AASStaticWebSources, "/static/<string:type>/<filename>",resource_class_args=tuple([self.pyAAS]))
