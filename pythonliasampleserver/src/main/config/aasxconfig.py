...
try:
    ...
    from pythonliasampleserver.src.main.utils.aaslog import AASDescriptor

try:
    from config.TemplateCapture import NameplateCapture, IdentificationCapture, DocumentCapture, TechnicalDataCapture
except ImportError:
    from pythonliasampleserver.src.main.config.TemplateCapture import NameplateCapture, IdentificationCapture, \
...
class ConfigParser(object):
    def __init__(self, pyAAS):
        ...
        with open(os.path.join(self.pyAAS.template_repository, "documentationInfo.json"),
                  encoding='utf-8') as json_file_document:
            self.templateData["Documentation"] = json.load(json_file_document)
        with open(os.path.join(self.pyAAS.template_repository, "namplateInfo.json"),
        ...
        with open(os.path.join(self.pyAAS.repository, "aasShell_JsonSchema.json"),
                  encoding='utf-8') as json_file_aasShell:
        ...
        with open(os.path.join(self.pyAAS.repository, "submodel_JsonSchema.json"),
                  encoding='utf-8') as json_file_submodel:
            self.submodelJsonSchema = json.load(json_file_submodel)
        with open(os.path.join(self.pyAAS.repository, "conceptDescription_JsonSchema.json"),
                  encoding='utf-8') as json_file_submodel:
        ...
        for aasIndex in self.pyAAS.aasContentData.keys():
            ...
            for submodel in aasN["submodels"]:
                ...
                if submodel["idShort"] == "ThingDescription":
                    self.stdSubmodelData["THING_DESCRIPTION"] = self.configureThingDescriptionProperties(submodel, aasN[
                        "identification"]["id"], aasIndex)
    ...
    def processSubmodelELement(self, submodelElement, submodelProperetyDict, idShortPath):
        if submodelElement["modelType"]["name"] == "SubmodelElementCollection":
            ...
            submodelProperetyDict[submodelElement["idShort"]] = {"data": collectionDict,
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "collection"}
        elif (submodelElement["modelType"]["name"] == "Property"):
            submodelProperetyDict[submodelElement["idShort"]] = {"data": submodelElement["value"],
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "Property",
                                                                 "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "Range"):
            submodelProperetyDict[submodelElement["idShort"]] = {
                "data": {"min": submodelElement["min"], "max": submodelElement["max"]},
                "qualifierList": self.getQualifiersList(submodelElement),
                "semanticIdList": self.getSemanticIdList(submodelElement), "type": "Range", "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "MultiLanguageProperty"):
            submodelProperetyDict[submodelElement["idShort"]] = {"data": submodelElement["value"],
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "MultiLanguageProperty",
                                                                 "idShortPath": idShortPath}
            ...
            submodelProperetyDict[submodelElement["idShort"]] = {"data": submodelElement["value"],
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "File",
                                                                 "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "Blob"):
            submodelProperetyDict[submodelElement["idShort"]] = {
                "data": self.parseBlobData(submodelElement["mimeType"], submodelElement["value"]),
                "mimeType": submodelElement["mimeType"], "qualifierList": self.getQualifiersList(submodelElement),
                "semanticIdList": self.getSemanticIdList(submodelElement), "type": "Blob", "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "ReferenceElement"):
            submodelProperetyDict[submodelElement["idShort"]] = {"data": submodelElement["value"],
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "ReferenceElement",
                                                                 "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "RelationshipElement"):
            submodelProperetyDict[submodelElement["idShort"]] = {
                "data": {"first": submodelElement["first"], "second": submodelElement["second"]},
                "qualifierList": self.getQualifiersList(submodelElement),
                "semanticIdList": self.getSemanticIdList(submodelElement), "type": "RelationshipElement",
                "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "AnnotatedRelationshipElement"):
            submodelProperetyDict[submodelElement["idShort"]] = {
                "data": {"first": submodelElement["first"], "second": submodelElement["second"]},
                "qualifierList": self.getQualifiersList(submodelElement),
                "semanticIdList": self.getSemanticIdList(submodelElement), "type": "AnnotatedRelationshipElement",
                "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "Capability"):
            submodelProperetyDict[submodelElement["idShort"]] = {"data": "Capability",
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "Capability",
                                                                 "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "Operation"):
            submodelProperetyDict[submodelElement["idShort"]] = {
                "data": {"inputVariable": submodelElement["inputVariable"],
                         "outputVariable": submodelElement["outputVariable"],
                         "inoutputVariable": submodelElement["inoutputVariable"]},
                "qualifierList": self.getQualifiersList(submodelElement),
                "semanticIdList": self.getSemanticIdList(submodelElement), "type": "Operation",
                "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "BasicEvent"):
            submodelProperetyDict[submodelElement["idShort"]] = {"data": submodelElement["observed"],
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "BasicEvent",
                                                                 "idShortPath": idShortPath}
        elif (submodelElement["modelType"]["name"] == "Entity"):
            submodelProperetyDict[submodelElement["idShort"]] = {"data": submodelElement["statements"],
                                                                 "qualifierList": self.getQualifiersList(
                                                                     submodelElement),
                                                                 "semanticIdList": self.getSemanticIdList(
                                                                     submodelElement), "type": "Entity",
                                                                 "idShortPath": idShortPath}
                        ...
                        if (pelem["idShort"] == "forms"):
                            for formConstraint in pelem["value"][0]["constraints"]:
                                if (formConstraint["type"] == "href"):
                                    ...
                                    self.pyAAS.tdPropertiesList[
                                        tdproperty["idShort"] + "_aasId" + str(aasIndex)] = tddata
    ...
    def getDcumentationData(self, submodel):
        ...
        for lang in languageDIct.keys():
            if i == 0:
                ...
                active = ""
                showActive = ""
            documentationData[lang] = {"data": self.reOrderEntityList(languageDIct[lang]), "active": active,
                                       "status": status, "showActive": showActive}
